...
let moto = document.querySelectorAll(".moto")
...
profilButton.addEventListener('click', function() {
    ...
    registerForm.style.padding = '40px';
    registerForm.style.boxSizing = 'border-box';
    registerForm.style.margin = '0 auto';
    registerForm.style.fontSize = '16px';
    registerForm.style.border = '1px solid black';
    ...
    registerForm.style.background = 'linear-gradient(to right, #0e0d0d, #252525)'; 
    registerForm.style.boxShadow = '0 4px 8px rgba(0, 0, 0, 0.2)'; 
...
function sort_moto(){
    ...
    for (let i = 0; i <moto.length; i++) {
       moto[i].style.display = 'flex';
    }
}
Moto.addEventListener('click', sort_moto)
